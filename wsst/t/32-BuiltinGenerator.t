...
BEGIN { use_ok("WSST::BuiltinGenerator"); }

can_ok("WSST::BuiltinGenerator", qw(generator_names generate));
...
my $obj = WSST::BuiltinGenerator->new();
ok(ref $obj, '$obj->new()');
is($obj->{tmpl_dir}, $WSST::COMMAND_OPTS->{defs}->{tmpl_dir}, '$obj->{tmpl_dir}');
